...
export default function GetPosts(num) { /*Exports a Get (All posts) action...*/
    ...
    return (dispatch) => {
        axios.get(`${process.env.REACT_APP_API_URL}/groupomania/posts`, { withCredentials: true }) /*...that runs a GET (All posts) request...*/
...
export function GetAllPosts() {
    ...
    return (dispatch) => {
        axios.get(`${process.env.REACT_APP_API_URL}/groupomania/posts`, { withCredentials: true })
...
export function AddPost(data) { /*Exports a Post (Add post) action...*/
    ...
    return (dispatch) => {
        axios({ /*...that runs a POST (Add post) request...*/
            method: "post",
            url: `${process.env.REACT_APP_API_URL}/groupomania/posts`,
            data: data,
...
export function LikePost(clientId, postId) { /*Exports a Patch (Like) action...*/
    ...
    return (dispatch) => {
        axios({ /*...that runs a PATCH (Like) request...*/
            method: "patch",
            url: `${process.env.REACT_APP_API_URL}/groupomania/posts/like/${postId}`,
            data: { "id": clientId },
            withCredentials: true
        })
...
export function UnlikePost(clientId, postId) { /*Exports a Patch (Unlike) action...*/
    ...
    return (dispatch) => {
        axios({ /*...that runs a PATCH (Unlike) request...*/
            method: "patch",
            url: `${process.env.REACT_APP_API_URL}/groupomania/posts/unlike/${postId}`,
            data: { "id": clientId },
            withCredentials: true
        })
...
export function UpdatePost(message, postId) { /*Exports a Put (Update) action...*/
    ...
    return (dispatch) => {
        axios({ /*...that runs a PUT (Update) request...*/
            method: "put",
            url: `${process.env.REACT_APP_API_URL}/groupomania/posts/${postId}`,
            data: { message },
            withCredentials: true
        })
...
export function AddComment(postId, commenterId, text, commenterPseudo) { /*Exports a Patch (Add comment) action...*/
    ...
    return (dispatch) => {
        axios({ /*...that runs a PATCH request...*/
            method: "patch",
            url: `${process.env.REACT_APP_API_URL}/groupomania/posts/comment/${postId}`,
            data: { commenterId, text, commenterPseudo },
            withCredentials: true
        })
            .then(() => {
                axios.get(`${process.env.REACT_APP_API_URL}/groupomania/posts`, { withCredentials: true }) /*...then runs a GET (Client) request...*/
...
export function EditComment(postId, commentId, commenterId, text) { /*Exports a Patch (Edit comment) action...*/
    ...
    return (dispatch) => {
        axios({ /*...that runs a PATCH request...*/
            method: "patch",
            url: `${process.env.REACT_APP_API_URL}/groupomania/posts/comment/edit/${postId}`,
...
export function DeleteComment(postId, commentId, commenterId) { /*Exports a Delete (comment) action...*/
    ...
    return (dispatch) => {
        axios({ /*...that runs a DELETE request...*/
            method: "delete",
            url: `${process.env.REACT_APP_API_URL}/groupomania/posts/comments/${postId}`,
